...
const ProjectInBudget = () => {
    ...
    return (
        <section className=" pt-3 bg-light" id="pricetrend">
            <Container>
                <Row className="mb-2 ">
                    <Col>
                ...
                <Row className="align-items-center bg-white py-1 mb-4">
                    <Col xs="12" md="2" className="fw-bold mb-2 mb-md-0">
                        Budget
                    </Col>
...
export default ProjectInBudget;
