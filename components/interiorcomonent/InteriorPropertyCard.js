                    ...
                    <Col sm="12" md="12" lg="6">
                        <Card className="p-2 border-0">
                            <div className="d-flex justify-content-between align-items-start flex-wrap">
                                <Link href="/interiors-detail">
                                    <Badge color="success">Verified Partner</Badge>
                                    <h6 className="text-dark mb-1">
                                        Interior Designers in Mangol Pur Kalan, New Delhi
                                        <span style={{ float: "right" }}>
                                            <FaHeart className="text-muted cursor-pointer me-2 text-st" />
                                            <FaShareAlt className="text-muted cursor-pointer text-st" />
                                        </span>
                                    </h6>
                                    <div className="text-st small fw-semibold mb-2">Reign o Space Interior</div>
...
export default InteriorPropertyCard;
